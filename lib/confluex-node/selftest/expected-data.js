...
const controlFiles = [
  ...
  'tests/fixtures/confluence-7137/comparison-rules.json'
]

const goldenDirectory = 'tests/fixtures/confluence-7137/expected/golden'
...
function retainedExpectedPath (sourcePath) {
  if (sourcePath === 'tests/fixtures/confluence-7137/comparison-rules.json') {
    return 'comparison-rules.json'
  }

  return sourcePath.replace('tests/fixtures/confluence-7137/expected/', '')
}
