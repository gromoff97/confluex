...
const commands = [
  ...
  },
  {
    ...
    usage: 'confluex selftest --url <base-url> --token <token>',
    examples: [
    ...
    options: [
      ...
      { token: '--token', value: '<token>', required: true, description: 'Bearer token used for selftest reset, fixture apply, and live regression.' },
      { token: '--env-file', value: '<file>', description: 'Read configuration from this env file.' }
    ],
    notes: []
  }
